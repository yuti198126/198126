...
mkdir -p $BUILD_DIR
CMAKE_EXTRAS="$CMAKE_EXTRAS -DCMAKE_BUILD_TYPE='Release' -DENABLE_CPPKIN=true -DENABLE_MULTIVERSION_PROTOCOL_TEST=true -DAMQP_CONN_STR='amqp://guest:guest@localhost:5672'"
